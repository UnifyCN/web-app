...
update public.groups set cover_photo_url = 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80&auto=format&fit=crop' where id = 4;  -- Tech Enthusiasts
update public.groups set cover_photo_url = 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=800&q=80&auto=format&fit=crop' where id = 5;  -- Book Club
update public.groups set cover_photo_url = 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80&auto=format&fit=crop' where id = 7;  -- Housing Assistance
update public.groups set cover_photo_url = 'https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?w=800&q=80&auto=format&fit=crop' where id = 11; -- International Students
update public.groups set cover_photo_url = 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&q=80&auto=format&fit=crop' where id = 12; -- PR Applicants
update public.groups set cover_photo_url = 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&q=80&auto=format&fit=crop' where id = 13; -- Working in Canada
