...
**Nothing here has been fixed.** The translation run deliberately left all English source
documents untouched (all 57 source `_rev`s were verified unchanged before and after).
This document is the actionable record.
...
### 1. `2fe61c79-bd30-44b1-8cd6-1976d4b5e6f4` — "Looking for Rental Housing"
...
### 2. `ecca3ca9-7b4a-4d22-a88d-2efc10f7d843` — "Activity: Mina's Story"
...
### 3. `ad1aa163-9193-4cbc-86dd-b214dbacf66b` — "Rental Quiz"
...
### 4. `b29a34f2-cb58-41bd-b220-c426ff466202` — "Home Buying Quiz"
...
### 5. `051870f8-3cab-4933-8130-0dcc31f61538`
