...
export function CommunityGraphic() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        {...item}
        className="absolute top-0 right-0 z-10 w-[180px] overflow-hidden rounded-2xl bg-[#F68B26] p-3 text-white shadow-md"
      >
      ...
      >
        <div className="relative h-16 w-full">
          ...
          />
          <div className="absolute top-2 left-2 flex flex-col items-center rounded-xl bg-[#ECE0D9] px-2 py-1 leading-none">
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#FBCFCF]">
            <span className="text-base font-bold text-[#E03B3B]">!</span>
          </div>
          <div>
        ...
        <div className="relative mt-3">
          <div className="absolute top-[14px] bottom-[14px] left-[13px] w-[1.5px] bg-[#E0DEDE]" />
            ...
            {tasks.map((task) => (
              <div key={task.label} className="relative z-10 flex items-start gap-2.5">
                <span
                  className={
                    task.done
                      ? "flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#E03B3B] text-white"
                      : "flex h-7 w-7 shrink-0 rounded-full border-2 border-[#E03B3B] bg-surface"
                  }
                >
      ...
      <motion.div
        {...item}
        className="absolute right-0 bottom-4 z-20 w-[186px] rounded-2xl border border-[#DBDBDB] bg-surface p-3 shadow-lg"
      >
        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#FBCFCF]">
          <ClipboardList className="h-4 w-4 text-[#E03B3B]" />
        </div>
        ...
        <div className="mt-2 flex items-center justify-center gap-1 rounded-lg bg-[#E03B3B] py-1.5 text-[10px] font-semibold text-white">
          Learn how <ArrowRight className="h-3 w-3" />
        </div>
        <div className="mt-1.5 flex items-center justify-center gap-1 rounded-lg bg-[#E2F6E2] py-1.5 text-[10px] font-semibold text-[#4E7E4C]">
...
export function CompanionGraphic() {
  ...
  return (
    ...
    >
      <motion.div
        {...item}
        className="absolute top-0 right-0 max-w-[210px] rounded-2xl rounded-tr-sm bg-[#5B7FC7] px-3 py-2 text-[11px] leading-snug text-white shadow-sm"
      >
      ...
      >
        <div className="flex-1 rounded-2xl border border-border-card bg-surface p-2.5">
          <div className="flex items-center gap-1.5">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#F4B9DF]">
              <MessageSquare className="h-3.5 w-3.5 text-[#C2407A]" />
            </div>
        ...
        <div className="flex-1 rounded-2xl border border-border-card bg-surface p-2.5">
          <div className="flex items-center gap-1.5">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#F6A94C]">
...
export function LearnGraphic() {
  ...
  return (
    <motion.div
      ...
      aria-hidden
    >
      {cards.map(({ label, sections, color, Icon, radius, box }) => (
        <motion.div
          key={label}
          {...item}
          className={`absolute overflow-hidden shadow-md ${radius}`}
