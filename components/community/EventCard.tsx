...
export function EventCard({ event }: { event: CommunityEvent }) {
  ...
  return (
    <Link
      ...
      className="flex flex-col overflow-hidden rounded-card border border-border-card bg-surface transition-all duration-200 hover:scale-[1.02] hover:shadow-md"
    >
